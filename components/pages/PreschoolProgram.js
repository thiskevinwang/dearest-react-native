...
export default function PreschoolProgram(props) {
  return (
    <View style={[props.style, styles.pageContainer]}>
      ...
      <Row>
        <Text style={{ flex: 1, paddingHorizontal: 20, ...styles.textBody }}>
          The Dearest Preschool Program is specifically designed for ages 2 - 4
          with our <Text style={{ color: ORANGE }}>Dearest curriculum</Text>.
          Spark your child’s love for learning and help them become school-ready
          through a quality in-home experience.
        </Text>
      </Row>
      ...
      <Row>
        <Text style={{ flex: 1, paddingHorizontal: 20, ...styles.textBody }}>
          ...
          hosting student’s home | Options for 2 or 3 days a week, AM (9am-12pm)
          or PM (3pm-6pm) | Reports & milestone tracking
        </Text>
      </Row>
